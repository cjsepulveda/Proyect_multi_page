...
def layout(): 
    ...
    # Marco para el gráfico (dcc.Graph está incorporado en la función update_charts)
        html.Div(id='grafico_diainfin' , className="wrapper"),
...
@callback(
        Output('grafico_diainfin', 'children'),
        [Input('level_diainfin', 'value'),
         Input('test_diainfin','value'),
         Input('subject_diainfin','value')]
        )
